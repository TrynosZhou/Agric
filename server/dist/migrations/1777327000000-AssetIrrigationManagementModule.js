...
exports.AssetIrrigationManagementModule1777327000000 = void 0;
class AssetIrrigationManagementModule1777327000000 {
    constructor() {
        this.name = "AssetIrrigationManagementModule1777327000000";
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "assets" ADD "condition" character varying(20) NOT NULL DEFAULT 'good'`);
        await queryRunner.query(`ALTER TABLE "assets" ADD "currentAssignedUser" character varying`);
        await queryRunner.query(`ALTER TABLE "assets" ADD "maintenanceLogEntries" jsonb NOT NULL DEFAULT '[]'::jsonb`);
        await queryRunner.query(`ALTER TABLE "irrigation_systems" ALTER COLUMN "systemType" TYPE character varying(20)`);
        ...
        await queryRunner.query(`UPDATE "irrigation_systems" SET "status" = CASE WHEN "statusLegacy" = true THEN 'active' ELSE 'inactive' END`);
        ...
        await queryRunner.query(`ALTER TABLE "irrigation_systems" ADD "waterUsageLog" jsonb NOT NULL DEFAULT '[]'::jsonb`);
        await queryRunner.query(`ALTER TABLE "irrigation_systems" ADD "fuelUsageLog" jsonb NOT NULL DEFAULT '[]'::jsonb`);
        await queryRunner.query(`ALTER TABLE "irrigation_systems" ADD "scheduledMaintenanceDates" jsonb NOT NULL DEFAULT '[]'::jsonb`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`UPDATE "irrigation_systems" SET "statusLegacy" = CASE WHEN "status" = 'active' THEN true ELSE false END`);
...
exports.AssetIrrigationManagementModule1777327000000 = AssetIrrigationManagementModule1777327000000;
