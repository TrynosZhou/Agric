...
exports.LabourManagementModule1777323000000 = void 0;
class LabourManagementModule1777323000000 {
    constructor() {
        this.name = "LabourManagementModule1777323000000";
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE "workers" ADD "name" character varying`);
        await queryRunner.query(`UPDATE "workers" SET "name" = TRIM(COALESCE("firstName",'') || ' ' || COALESCE("lastName",'')) WHERE "name" IS NULL`);
        await queryRunner.query(`ALTER TABLE "workers" ADD "type" character varying(20) NOT NULL DEFAULT 'casual'`);
        await queryRunner.query(`ALTER TABLE "workers" ADD "wageRate" numeric(12,2)`);
        await queryRunner.query(`ALTER TABLE "workers" ADD "casualPayMode" character varying(20) NOT NULL DEFAULT 'day'`);
        ...
        await queryRunner.query(`ALTER TABLE "worker_attendance" ADD "hoursWorked" numeric(6,2) NOT NULL DEFAULT 0`);
        await queryRunner.query(`ALTER TABLE "worker_attendance" ADD "taskPerformed" character varying`);
        await queryRunner.query(`ALTER TABLE "worker_attendance" ADD "allocationSystem" character varying(20)`);
...
exports.LabourManagementModule1777323000000 = LabourManagementModule1777323000000;
