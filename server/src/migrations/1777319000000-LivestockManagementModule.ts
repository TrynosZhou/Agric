...
export class LivestockManagementModule1777319000000 implements MigrationInterface {
  name = "LivestockManagementModule1777319000000";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "livestock_animals" ADD "weightHistory" jsonb NOT NULL DEFAULT '[]'::jsonb`
    );
    await queryRunner.query(
      `ALTER TABLE "livestock_animals" ADD "vaccinationRecords" jsonb NOT NULL DEFAULT '[]'::jsonb`
    );
    await queryRunner.query(
      `ALTER TABLE "livestock_animals" ADD "dippingRecords" jsonb NOT NULL DEFAULT '[]'::jsonb`
    );
    await queryRunner.query(
      `ALTER TABLE "livestock_animals" ADD "treatmentHistory" jsonb NOT NULL DEFAULT '[]'::jsonb`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "livestock_animals" ADD "dailyMilkProduction" jsonb NOT NULL DEFAULT '[]'::jsonb`
    );
    await queryRunner.query(
      `ALTER TABLE "livestock_animals" ADD CONSTRAINT "UQ_livestock_animals_tagIdNumber" UNIQUE ("tagIdNumber")`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "livestock_animals" DROP CONSTRAINT "UQ_livestock_animals_tagIdNumber"`
    );
