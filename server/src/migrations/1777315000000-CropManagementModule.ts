...
export class CropManagementModule1777315000000 implements MigrationInterface {
  name = "CropManagementModule1777315000000";
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "crops" ADD "growthStage" character varying NOT NULL DEFAULT 'planned'`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "crops" ADD "fertilizerApplications" jsonb NOT NULL DEFAULT '[]'::jsonb`
    );
    await queryRunner.query(
      `ALTER TABLE "crops" ADD "pesticideApplications" jsonb NOT NULL DEFAULT '[]'::jsonb`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "tomato_harvest_cycles" DROP CONSTRAINT "FK_tomato_harvest_cycles_crop"`
    );
    await queryRunner.query(
      `ALTER TABLE "detasseling_tasks" DROP CONSTRAINT "FK_detasseling_tasks_crop"`
    );
